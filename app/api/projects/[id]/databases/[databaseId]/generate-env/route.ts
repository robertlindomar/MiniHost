...
import { buildEnvFile, decryptDatabasePassword, sanitizeProjectDatabaseForAudit } from "@/lib/server/project-database";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    if (existing.status === "ARCHIVED") {
      return fail("Não é possível gerar .env de um banco arquivado.");
    }
